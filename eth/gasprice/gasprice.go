...
var (
	DefaultMaxPrice    = big.NewInt(500 * params.DNGWei)
	DefaultIgnorePrice = big.NewInt(2 * params.DNWei)

	DefaultMinSuggestedPriorityFee = big.NewInt(1e6 * params.DNWei) // 0.001 gwei, for Optimism fee suggestion
)
