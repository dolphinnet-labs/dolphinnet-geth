...
var (
	DefaultMaxPrice    = big.NewInt(500 * params.DOLGWei)
	DefaultIgnorePrice = big.NewInt(2 * params.DOLWei)

	DefaultMinSuggestedPriorityFee = big.NewInt(1e6 * params.DOLWei) // 0.001 gwei, for Optimism fee suggestion
)
